...
Fighter_Aircraft::Fighter_Aircraft(std::string name, int number_of_passengers, int number_of_turbines, double size_in_meters, double autonomy_in_kilometers, float top_speed, int number_of_missiles) {
...
void Fighter_Aircraft::shoot2(int number_of_missiles_to_fire) {
